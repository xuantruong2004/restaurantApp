...
import { getAllFoodItems, saveItem } from '../utils/firebaseFuntion';
      ...
      >
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2 ">
          ...
          <input
            ...
            className="w-full h-full border-none outline-none placeholder:text-gray-400 text-textColor text-lg bg-transparent "
          />
        </div>
              ...
              {!imageAsset ? (
                ...
                <>
                  <div className="relative h-full">
                    ...
                    <button
                      type="button"
                      className="absolute flex items-center justify-center bottom-1 right-0  px-2 md:px-3 py-1 rounded-full bg-red-500 text-sm md:text-xl cursor-pointer 
